Feature: Attaching a series of notable events leading up to errors
  ...
  Scenario: Network breadcrumbs
    ...
    And the event "breadcrumbs.0.metaData.url" equals "http://maze-local:9340/reflect/"
    ...
    And the event "breadcrumbs.1.metaData.url" equals "http://maze-local:9340/reflect/"
